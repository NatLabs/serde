...
func validate_decoding(candid_values : [Candid.Candid]) : Bool {
    ...
    let #ok(decoded) = CandidDecoder.one_shot(encoded, RecordKeys, null);

    Debug.print("(decoded, expected): " # debug_show (decoded, candid_values));

    candid_values == decoded;
};
    ...
    func() {
        ...
        test(
            ...
            func() {
                ...
                // assert validate_encoding([#Int(115_792_089_237_316_195_423_570_985_008_687_907_853_269_984_665_640_564_039_457_584_007_913_129_639_936)]);
                // assert validate_encoding([#Int(-115_792_089_237_316_195_423_570_985_008_687_907_853_269_984_665_640_564_039_457_584_007_913_129_639_936)]);
        ...
        test(
            ...
            func() {
                ...
                assert validate_encoding([#Tuple([#Array([#Nat(0)]), #Option(#Text("random")), #Record([("a", #Array([#Nat(0)])), ("b", #Option(#Text("random"))), ("c", #Int(1))])])]);
            },
        );
